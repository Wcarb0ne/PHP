...
<div class="row">
    ...
    <div class="row mt-1"><!-- Descrição -->
        <div class="col-sm-12">
            ...
            <textarea name="txtDescricao" id="txtDescricao" class="form-control" rows="5" placeholder="Insira a observação do cadastro (campo Obrigatório)"><?=$descricao_Categoria?></textarea>
        </div>
    </div>
    <div class="row mt-1"><!-- Observação -->
        <div class="col-sm-12">
            <label for="Nome">Observação</label>
            <textarea name="txtObs" id="txtObs" class="form-control" rows="5" placeholder="Insira a observação do cadastro (campo não obrigatório)"><?=$obs_Categoria?></textarea>
        </div>
    </div>
    <div class="row mt-4 mb-4"><!--botoes-->
        <div class="col-sm-12">
            <button name="btoPesquisa" class="btn btn-primary"formaction="Login_sistema.php?Tela=Categoria">Pesquisar</button>
            <button name="btoCadastrar" class="btn btn-success"formaction="Categoria_btoCadastrar.php?Tela=Categoria">Cadastrar</button>
            <button name="btoAlterar" class="btn btn-warning"formaction="Categoria_btoAlterar.php?Tela=Categoria">Alterar</button>
